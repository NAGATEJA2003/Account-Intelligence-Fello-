...
TOTAL_RECORDS = 5   # Number of signals to generate
...
def run():
    ...
    if os.path.exists('visitor_signals.json'):
    ...
    with open('master_intelligence.json', 'w', encoding='utf-8') as f:
    ...
    time.sleep(2) 
    if os.path.exists('master_intelligence.json'):
